...
public final class SLF4JLoggerProxy {
	...
	private static final Logger UNKNOWN_LOGGER = LoggerFactory
			.getLogger(UNKNOWN_LOGGER_NAME);
	...
	private static boolean log(Logger logger, String proxy, int level,
			String message) {
	...
	private static boolean log(Logger logger, String proxy, int level,
		...
		((LocationAwareLogger) logger).log(null, proxy, level, message, null,
				throwable);
		return true;
	}
	...
	/**
	 * Attempts to log the given parameterized message and throwable using the given logger at the given level and via the given logging proxy. Logging takes place only of the logger is
	 * location-aware.
	 * 
	 * @param logger The logger.
	 * @param proxy The proxy.
	...
	private static boolean log(Logger logger, String proxy, int level,
			Throwable throwable, String message, Object[] params) {
		if (!(logger instanceof LocationAwareLogger)) {
			return false;
		}
	...
	static void errorProxy(String proxy, Object category, Throwable throwable) {
		...
		if (log(logger, proxy, LocationAwareLogger.ERROR_INT, UNKNOWN_MESSAGE,
				throwable)) {
			return;
		}
	...
	public static void error(Object category, Exception throwable) {
		errorProxy(SELF_PROXY, category, throwable.getMessage());
	}
	...
	static void errorProxy(String proxy, Object category, String message,
		...
		if (log(logger, proxy, LocationAwareLogger.ERROR_INT, message, params)) {
			return;
		}
	...
	static void errorProxy(String proxy, Object category, Throwable throwable,
		...
		if (log(logger, proxy, LocationAwareLogger.ERROR_INT, throwable,
				message, params)) {
			return;
		}
	...
	static void warnProxy(String proxy, Object category, Throwable throwable) {
		...
		if (log(logger, proxy, LocationAwareLogger.WARN_INT, UNKNOWN_MESSAGE,
				throwable)) {
			return;
		}
	...
	static void warnProxy(String proxy, Object category, String message,
		...
		if (log(logger, proxy, LocationAwareLogger.WARN_INT, message, throwable)) {
			return;
		}
	...
	static void warnProxy(String proxy, Object category, String message,
		...
		if (log(logger, proxy, LocationAwareLogger.WARN_INT, message, params)) {
			return;
		}
	...
	static void warnProxy(String proxy, Object category, Throwable throwable,
		...
		if (log(logger, proxy, LocationAwareLogger.WARN_INT, throwable,
				message, params)) {
			return;
		}
	...
	static void infoProxy(String proxy, Object category, Throwable throwable) {
		...
		if (log(logger, proxy, LocationAwareLogger.INFO_INT, UNKNOWN_MESSAGE,
				throwable)) {
			return;
		}
	...
	static void infoProxy(String proxy, Object category, String message,
		...
		if (log(logger, proxy, LocationAwareLogger.INFO_INT, message, throwable)) {
			return;
		}
	...
	static void infoProxy(String proxy, Object category, String message,
		...
		if (log(logger, proxy, LocationAwareLogger.INFO_INT, message, params)) {
			return;
		}
	...
	static void infoProxy(String proxy, Object category, Throwable throwable,
		...
		if (log(logger, proxy, LocationAwareLogger.INFO_INT, throwable,
				message, params)) {
			return;
		}
	...
	static void debugProxy(String proxy, Object category, Throwable throwable) {
		...
		if (log(logger, proxy, LocationAwareLogger.DEBUG_INT, UNKNOWN_MESSAGE,
				throwable)) {
			return;
		}
	...
	static void debugProxy(String proxy, Object category, String message,
		...
		if (log(logger, proxy, LocationAwareLogger.DEBUG_INT, message, params)) {
			return;
		}
	...
	static void debugProxy(String proxy, Object category, Throwable throwable,
		...
		if (log(logger, proxy, LocationAwareLogger.DEBUG_INT, throwable,
				message, params)) {
			return;
		}
	...
	static void traceProxy(String proxy, Object category, Throwable throwable) {
		...
		if (log(logger, proxy, LocationAwareLogger.TRACE_INT, UNKNOWN_MESSAGE,
				throwable)) {
			return;
		}
	...
	static void traceProxy(String proxy, Object category, String message,
		...
		if (log(logger, proxy, LocationAwareLogger.TRACE_INT, message, params)) {
			return;
		}
	...
	static void traceProxy(String proxy, Object category, Throwable throwable,
		...
		if (log(logger, proxy, LocationAwareLogger.TRACE_INT, throwable,
				message, params)) {
			return;
		}
		logger.trace(message, params, throwable);
	}
